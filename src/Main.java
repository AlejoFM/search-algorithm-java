...
public class Main {
    public static void main(String[] args) {
        ...
        String patternGenerated = StringGen.generateString(10);
        ...
        System.out.println("Positions found (Java): " + searchResultJava);
        System.out.println("Positions found (Alejo): " + searchResultAlejo);
